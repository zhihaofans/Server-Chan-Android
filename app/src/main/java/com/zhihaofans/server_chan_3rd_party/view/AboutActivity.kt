...
class AboutActivity : AppCompatActivity(), AnkoLogger {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val items: Array<String> = arrayOf(getString(R.string.text_about) + getString(R.string.text_thisApp), getString(R.string.text_about) + getString(R.string.text_serverChan), getString(R.string.text_sourceCode) + "(Github)", getString(R.string.text_bugs))
